...
#define Key_UpArrow (Key){ KEY_FLAGS, HID_KEYBOARD_UPARROW }
#define Key_DnArrow (Key){ KEY_FLAGS, HID_KEYBOARD_DOWNARROW }
#define Key_LArrow (Key){ KEY_FLAGS, HID_KEYBOARD_LEFTARROW }
#define Key_RArrow (Key){ KEY_FLAGS, HID_KEYBOARD_RIGHTARROW }
...
#define Key_KeypadMinus (Key){ KEY_FLAGS|SHIFT_HELD, HID_KEYPAD_PLUS_SLASH_MINUS }
#define Key_KeypadPlus (Key){ KEY_FLAGS, HID_KEYPAD_PLUS_SLASH_MINUS }
...
// TODO FIND THESE KEYS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#define HID_KEYBOARD_BACKLIGHT_DOWN 0xF1
#define Key_BacklightDn (Key){ KEY_FLAGS, HID_KEYBOARD_BACKLIGHT_DOWN }
#define HID_KEYBOARD_BACKLIGHT_UP 0xF2
#define Key_BacklightUp (Key){ KEY_FLAGS, HID_KEYBOARD_BACKLIGHT_UP }
#define NO_KEY false


#define KEY_RIGHT_FN2 0xfe
#define Key_RFN2 (Key){ KEY_FLAGS, HID_KEYBOARD_RIGHT_FN2 }
#define KEY_LEFT_FN2 0xff
#define Key_LFN2 (Key){ KEY_FLAGS, HID_KEYBOARD_LEFT_FN2 }
